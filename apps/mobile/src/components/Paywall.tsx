...
const COPY: Record<PaywallReason, { title: string; body: string }> = {
  ...
  NIGHT: { title: 'A night you choose.', body: 'Say what you want tonight in one line. Plus gets one a night, written for you alone.' },
...
const OPENS = ['Unmetered nights, no fifteen-message cap', 'A night you choose, every night', 'A picture from him, every day', 'His calls, in his voice', 'Every story again, every other door', 'Everything he remembers, kept for good']
