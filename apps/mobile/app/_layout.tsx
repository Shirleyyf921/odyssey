...
if (__DEV__ && typeof window !== 'undefined') (window as unknown as { __odyssey?: unknown }).__odyssey = { paywall: (r: 'CAP' | 'CALL' | 'EPISODE' | 'REPLAY' | 'PHOTO' | 'MEMORY' | 'GENERIC') => usePaywall.getState().open(r) }
